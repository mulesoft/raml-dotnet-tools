...
namespace RAML.WebApiExplorer
{
    public class Raml1TypeBuilder
    {
        ...
        {
            return (type.GetTypeInfo().BaseType != null && type.GetTypeInfo().BaseType != typeof(Object) && IsDictionary(type.GetTypeInfo().BaseType));
        }
        ...
        private RamlType GetEnum(Type type)
        {
            ...
            {
                Type = "string",
                Scalar = new Property { Enum = type.GetTypeInfo().GetEnumNames() } // TODO: check!!
            };
        ...
        {
            return (type.GetTypeInfo().BaseType != null && type.GetTypeInfo().BaseType != typeof(object)) || type.GetProperties().Any(p => p.CanWrite);
        }
