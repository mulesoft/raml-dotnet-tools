...
//        private readonly IDictionary<Type, Shape> types = new Dictionary<Type, Shape>();
...
//                    returnedShape = GetArrayOfArray(subElementType);
//                }
//                else
//                {
...
//                    returnedShape = GetArray(elementType);                    
//                }
//            }
//            else if (IsDictionary(type) || IsParentADictionary(type) )
//            {
//                types.Add(type);
//                returnedShape = GetMap(type);
//            }
//            else if (type.IsEnum)
//            {
//                types.Add(type);
//                returnedShape = GetEnum(type);
//            }
...
//                types.Add(type);
//                returnedShape = GetObject(type);
//            }

//            if(returnedShape != null)
//                AddType(type, returnedShape);
