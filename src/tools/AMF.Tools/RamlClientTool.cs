...
//                var result = RegenerateCode(wszInputFilePath, extensionPath).ConfigureAwait(false).GetAwaiter().GetResult();
//                if (!result.IsSuccess)
//                {
//                    pcbOutput = 0;
...
//                var ramlFile = mainRamlPath.Substring(mainRamlPath.LastIndexOf(Path.DirectorySeparatorChar)) + GetExtension(document.Path);
//                mainRamlPath = mainRamlPath + ramlFile;
//                RegenerateCode(mainRamlPath, extensionPath).Wait();
//            }
//            else
//            {
//                RegenerateCode(document.FullName, extensionPath).Wait();
//            }
//        }
...
//        public static async Task<CodeRegenerationResult> RegenerateCode(string ramlFilePath, string extensionPath)
//        {
